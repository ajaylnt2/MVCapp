    ...
    public class PlantInfo
    {
        ...
        public List<PlantInfoModel> RetrievePlantInfo()
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    var command = new SqlCommand("Select * from dbo.WAGES_Plant_Details", conn);
        ...
        public List<string> GetCountry()
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (var cmd = new SqlCommand("select distinct Name from [dbo].[WAGES_Master_Country]", conn))
                    {
        ...
        public List<Asset> RetrieveAsset()
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    using (var command = new SqlCommand("select * from dbo.WAGES_Asset_Classification", connection))
                    {
                        command.CommandType = CommandType.Text;
        ...
        public List<string> GetEquipmentType()
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (var cmd = new SqlCommand("select distinct Name from [dbo].[WAGES_Master_Asset_Type] where Parent_ID = 4", conn))
                    {
                        cmd.CommandType = CommandType.Text;
                        using (var reader = cmd.ExecuteReader())
                        {
        ...
        public List<string> GetUOM()
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (var cmd = new SqlCommand("SELECT distinct [Description] FROM [dbo].[WAGES_Master_Wages_UOM]", conn))
                    {
                        cmd.CommandType = CommandType.Text;
                        using (var reader = cmd.ExecuteReader())
                        {
        ...
        public List<string> GetEnergyType()
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (var cmd = new SqlCommand("SELECT distinct Description FROM [dbo].[WAGES_Master_Wages_type]", conn))
                    {
                        cmd.CommandType = CommandType.Text;
                        using (var reader = cmd.ExecuteReader())
                        {
        ...
        public List<string> GetZone()
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (var cmd = new SqlCommand("SELECT distinct Name FROM [dbo].[WAGES_Master_Zone]", conn))
                    {
                        cmd.CommandType = CommandType.Text;
                        using (var reader = cmd.ExecuteReader())
                        {
        ...
        public List<string> RetrieveAssetType()
        {
            ...
            try
            {
                using (var connection = new SqlConnection(_connectionstring))
                {
                    connection.Open();
                    using (var command = new SqlCommand
                        ("select * from [dbo].[WAGES_Master_Asset_Type]"
                        , connection))
                    {
                        command.CommandType = CommandType.Text;
                        using (var reader = command.ExecuteReader())
        ...
        public List<string> RetrieveAsset(string assetType)
        {
            ...
            try
            {
                using (var connection = new SqlConnection(_connectionstring))
                {
                    connection.Open();
                    using (var command = new SqlCommand
                        ("select a.Name from [dbo].[WAGES_Asset_Classification] a inner join [dbo].[WAGES_Master_Asset_Type] b on a.Type = b.ID  where b.Name = @Name"
                        , connection))
                    {
                        command.CommandType = CommandType.Text;
        ...
        public DataTable GetConfig()
        {
            ...
            var query = "SELECT * FROM [dbo].[WAGES_Emailer_Config]";
        ...
        {
            var query = "SELECT * FROM [dbo].[WAGES_Email_Templates]";
            return CreateDataTable(query);
